...
// Thank you Saji Wang!
// I decided to use this algorithm because I'm not that good with graphs and I wanted to try this one
...
rs.on("close", () => {
  ...
  console.log(searchAStar().length - 1);
});
